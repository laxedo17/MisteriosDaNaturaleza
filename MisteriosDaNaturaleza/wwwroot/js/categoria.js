    ...
    taboaDeDatos = $('#tblData').DataTable(
        {
            ...
            "columns": [
                ...
                {
                    "data": "ordeDeExposicion", "width": "20%"
                },
                {
                    "data": "id",
                    "render": function (data) {
                        return `<div class="text-center">
                                    <a href="/Admin/categoria/ActualInsertar/${data}" class='btn btn-success text-white' style='cursor:pointer, width:100px;'>
